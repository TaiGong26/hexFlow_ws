...
def _show_state(arm_state, fps_info=""):
    lines = ["=== Mujoco Archer Y6 Test ==="]
...
def main():
    ros_interface = DataInterface("mujoco_archer_y6_test", rate_hz=100.0)
